                ...
                <div className="install-content">
                    ...
                    <div className="install-text">
                        ...
                        <p style={{ marginTop: '12px', fontSize: '0.8rem', color: '#94a3b8', borderTop: '1px solid #334155', paddingTop: '8px' }}>
                            pour utiliser votre application sur ordinateur, rendez-vous sur <strong>www.artisanflow-appli.com</strong> et cliquez sur <strong>Ajouter ArtisanFlow en favori sur ordinateur</strong> en dessous du bouton INSCRIPTION
                        </p>
                    </div>
                </div>
