...
const HomePage = () => {
    ...
    React.useEffect(() => {
        ...
        console.log('Debug PWA: Desktop detected?', !isMobile, 'Mac detected?', /mac/.test(userAgent), 'UserAgent:', userAgent);
    }, []);
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{ backgroundColor: 'rgba(255,255,255,0.05)', padding: '15px', borderRadius: '8px', margin: '20px 0' }}>
                                            ...
                                            <ol style={{ margin: 0, paddingLeft: '20px', lineHeight: '1.8' }}>
                                                <li>Appuyez sur <span style={{ backgroundColor: '#334155', padding: '2px 6px', borderRadius: '4px', fontFamily: 'monospace' }}>{isMac ? 'Cmd + D' : 'Ctrl + D'}</span> sur votre clavier</li>
